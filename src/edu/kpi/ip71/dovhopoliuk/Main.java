...
import edu.kpi.ip71.dovhopoliuk.polyalphabetic.PolyalphabeticSolution;
...
//        new SubstitutionSolution().solve("resources/substitution/input.txt", "resources/substitution/output.txt");
        new PolyalphabeticSolution().solve("resources/polyalphabetic/input.txt", "resources/polyalphabetic/output.txt");
    }
}
